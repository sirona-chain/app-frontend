            ...
            <div className="flex flex-col justify-center space-y-4">
              <div className="space-y-2">
                ...
                <p className="max-w-[600px] text-[#4D6D6A] md:text-xl dark:text-[#4D6D6A]">
                  Discover a personalized, secure, and seamless therapy experience with our AI-powered chatbot on
                  sirona.help.
                </p>
              </div>
            ...
            <div className="flex flex-col justify-center space-y-4">
              <div className="space-y-2">
                ...
                <p className="max-w-[600px] text-[#4D6D6A] md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-[#4D6D6A]">
                  Our AI-powered chatbot on sirona.help adapts to your unique needs, providing personalized therapy
                  sessions that address your specific concerns.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid gap-6 lg:grid-cols-[500px_1fr] lg:gap-12 xl:grid-cols-[600px_1fr]">
            <div className="flex flex-col justify-center space-y-4">
              <div className="space-y-2">
                ...
                <p className="max-w-[600px] text-[#4D6D6A] md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-[#4D6D6A]">
                  Your personal data is securely stored and encrypted on sirona.help, ensuring your privacy is protected
                  at all times.
                </p>
              </div>
            </div>
          ...
          <div className="grid gap-6 lg:grid-cols-[1fr_500px] lg:gap-12 xl:grid-cols-[1fr_600px]">
            ...
            <div className="flex flex-col justify-center space-y-4">
              <div className="space-y-2">
                ...
                <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl text-[#0E4D4A]">
                  Connecting to Your Substrate Parachain on Sirona
                </h2>
                <p className="max-w-[600px] text-[#4D6D6A] md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-[#4D6D6A]">
                  Our chatbot on sirona.help seamlessly integrates with your Substrate parachain, allowing for a
                  seamless and secure therapy experience.
                </p>
              </div>
            </div>
          </div>
